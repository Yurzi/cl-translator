...
#define YURZI_LOG_LEVEL(logger, level)                                                                            \
    ...
    yurzilog::LogEventWarpper(                                                                                    \
        std::make_shared<yurzilog::LogEvent>(                                                                     \
            logger, level, __FILE_NAME__, __LINE__, 0, yurzilog::GetThreadId(), time(0))) \
    .getSS()
...
#define YURZI_LOG_FMT_DEBUG(logger, fmt, ...) YURZI_LOG_FMT_LEVEL(logger, yurzilog::LogLevel::DEBUG, fmt, ##__VA_ARGS__)
#define YURZI_LOG_FMT_INFO(logger, fmt, ...) YURZI_LOG_FMT_LEVEL(logger, yurzilog::LogLevel::INFO, fmt, ##__VA_ARGS__)
#define YURZI_LOG_FMT_WARN(logger, fmt, ...) YURZI_LOG_FMT_LEVEL(logger, yurzilog::LogLevel::WARN, fmt, ##__VA_ARGS__)
#define YURZI_LOG_FMT_ERROR(logger, fmt, ...) YURZI_LOG_FMT_LEVEL(logger, yurzilog::LogLevel::ERROR, fmt, ##__VA_ARGS__)
#define YURZI_LOG_FMT_FATAL(logger, fmt, ...) YURZI_LOG_FMT_LEVEL(logger, yurzilog::LogLevel::FATAL, fmt, ##__VA_ARGS__)
